...
try:
    ...
    performances = program_bs.find_all('div', class_='performance')
    print(f'Found {len(performances)} performances on initial page')

    # Try to load more by scrolling/clicking if available
